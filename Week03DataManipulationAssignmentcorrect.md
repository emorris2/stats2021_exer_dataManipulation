...
-   List each variable and the level of measurement. Note if there are
    ...
    -   sex - nominal, no issues noted \#Answer Variables=11
...
```
    ...
    ##        frst1      frst2      frst3  bmi
    ## 1 moderately   a little   a little 21.6
    ## 2 moderately   a little moderately 29.6
    ## 3     mostly moderately     mostly 25.0
    ## 4     mostly moderately     mostly 25.6
    ## 5 moderately   a little     mostly 25.6
    ## 6     mostly moderately moderately 22.8
...
-   How do the z-scores compare between the sum scores and the mean
    ...
    -   Answer: It is okay for the mean to have missing value numbers.
        The sum needs to have the same number of answers for each
        variable present.
...
-   What does it mean if a z-score is positive or negative?
    ...
    -   positive:its above the mean
    -   negative:its below the mean
